...
func SetupRoutes(e *echo.Echo) {
	...
	gAdmins.GET("/doctor-payment", controllers.GetAllDoctorsPaymentsByAdminsController, AdminJWT)
	gAdmins.GET("/doctor-payments", controllers.GetDoctorTransactionByIDController, AdminJWT)
	...
	gAdmins.GET("/medicines/:id", controllers.GetMedicineAdminByIDController, AdminJWT)
	...
	gAdmins.GET("/medicines/:id/image", controllers.GetImageMedicineController, AdminJWT)
