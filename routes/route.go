...
func SetupRoutes(e *echo.Echo) {
	...
	gUsers.POST("/doctor-payments/?doctor=", controllers.CreateDoctorTransaction, UserJWT)
	gUsers.GET("/doctor-payments/?status=", controllers.GetDoctorTransactionByStatusController, UserJWT)
