...
func SetupRoutes(e *echo.Echo) {
	...
	gAdmins.GET("/medicines/:medicines_id", controllers.GetMedicineAdminByIDController)
	// gAdmins.GET("/medicine", controllers.GetMedicineByNameAdminController)
	gAdmins.PUT("/medicines/:medicines_id", controllers.UpdateMedicineController, AdminJWT)
	gAdmins.DELETE("/medicines/:medicines_id", controllers.DeleteMedicineController, AdminJWT)
	gAdmins.GET("/medicines/:medicines_id/image", controllers.GetImageMedicineController)
	gAdmins.PUT("/medicines/:medicines_id/image", controllers.UpdateImageMedicineController, AdminJWT)
	gAdmins.DELETE("/medicines/:medicines_id/image", controllers.DeleteImageMedicineController, AdminJWT)
